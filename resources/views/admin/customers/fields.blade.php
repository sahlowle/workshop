    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
                {!! Form::text('address', null,  ['readonly','onclick'=>'document.getElementById("googleMap").scrollIntoView({ behavior: "smooth" })','class' => 'form-control','id'=>'address','placeholder'=>  trans("Select address from map")]) !!}
            </div>
          </div>
