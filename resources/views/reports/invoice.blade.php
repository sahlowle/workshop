			...
			<div style="font-family: 'Linotype Ergo W01 Compressed'">
				<div class="row">
					...
					<div class="column" style=" width: 25%; text-align: center; min-height: 106px; ">
						<table class="meta meta-left" style=" width: 100%; margin: 45px 0px 0px 0px; ">
							<tr>
								<td>
									<span class="wordbr" contenteditable> {{ $order->subtotal }}  </span>
								</td>
							</tr>
						</table>
									...
									<table class="meta meta-left" style=" width: 59%; ">
										<tbody>
											<tr>
												...
												<td>
													<span class="wordbr" contenteditable=""> {{ $order->paid_amount }} </span>
												</td>
												<td class="euro">
													<span>€</span>
												</td>
											...
											<tr>
												...
												<td>
													<span class="wordbr" contenteditable="" > {{ $order->max_maintenance_price	 }}  </span>
												</td>
												<td class="euro">
													<span>€</span>
												</td>
					...
					<div class="column" style=" width: 25%; text-align: center;">
						<div>
							<table class="meta meta-left" style=" width: 100%; margin: 45px 0px 0px 0px; ">
								<tr>
									<td>
										<span class="wordbr" contenteditable> {{ $order->vat }}  </span>
									</td>
								</tr>
							</table>
						...
						<div>
							<table class="meta meta-left" style=" width: 100%; margin: 45px 0px 0px 0px; ">
								<tr>
									<td>
										<span class="wordbr" contenteditable>  {{ $order->total }} </span>
									</td>
								</tr>
							</table>
